...
import static java.util.stream.Collectors.toCollection;
    ...
    public class IPLAnalyser {
        ...
        Map<String, IPLDAO> cricketLeagueMap = null;

        public IPLAnalyser() {
            cricketLeagueMap = new HashMap<String, IPLDAO>();
        }

        public int loadIPLFactSheetData(PlayerType playerType, String... csvFilePath) throws IPLAnalyserException {
            cricketLeagueMap = new IPLDataLoader().loadIPLFactSheetData(playerType, csvFilePath);
            return cricketLeagueMap.size();
        }

        public String getFieldWiseSortedPlayersData(PlayerType playerType, SortBy.Field... field) throws IPLAnalyserException {
