...
public class SortBy {
    ...
    public enum Field {
        AVERAGE_OF_BATSMAN, STRIKE_RATE, FOURS_SIXES_RATE, FOURS_SIXES_WITH_STRIKE_RATE, AVERAGE_OF_BATSMAN_WITH_STRIKE_RATE, RUNS_WITH_AVERAGE, BOWLING_AVERAGE;
    }
    ...
    public static Comparator getComparatorField(SortBy.Field field) {
        ...
        Comparator<IPLDAO> iplStrikingRateBowlerComparator = Comparator.comparing(census -> census.strikeRate);
